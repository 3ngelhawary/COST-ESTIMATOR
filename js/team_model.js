...
(function () {
  ...
  function getActive(st){
    ...
    fac.forEach(r=>{
      if(!r.doMEP) return;
      Object.entries(r.mep||{}).forEach(([k,v])=>{ if(v===true) usedMEP.add(canon(k)); });
    });
  ...
  function build(st){
    ...
    if (A.wet){ add("Senior – Wet Utilities",1); add("Junior – Wet Utilities",1); add("Draftsman – Wet Utilities", dft); }
    if (A.dry){ add("Senior – Dry Utilities",1); add("Junior – Dry Utilities",1); add("Draftsman – Dry Utilities", dft); }
    if (A.roads){ add("Senior – Roads",1); add("Junior – Roads",1); add("Draftsman – Roads", dft); }
    if (A.landscape){ add("Senior – Landscape",1); add("Junior – Landscape",1); add("Draftsman – Landscape", dft); }
    if (A.secIrr){ add("Senior – Secondary Irrigation",1); add("Junior – Secondary Irrigation",1); add("Draftsman – Secondary Irrigation", dft); }
  ...
  function engineersFor(st, key){
    ...
    if(key==="wet") return pick("Senior – Wet Utilities")+pick("Junior – Wet Utilities");
    if(key==="dry") return pick("Senior – Dry Utilities")+pick("Junior – Dry Utilities");
    if(key==="roads") return pick("Senior – Roads")+pick("Junior – Roads");
    if(key==="landscape") return pick("Senior – Landscape")+pick("Junior – Landscape");
    if(key==="secIrr") return pick("Senior – Secondary Irrigation")+pick("Junior – Secondary Irrigation");
    if(key==="arch") return pick("Senior – Architecture")+pick("Junior – Architecture");
    if(key==="str") return pick("Senior – Structure")+pick("Junior – Structure");
    if(key==="mep"){
      return pick("Senior – MEP")
